.. meta::
   :title: sonyflake documentation
   :description: Sonyflake is a distributed unique ID generator.
   :language: en-GB
   :keywords: sonyflake, snowflake
   :copyright: Iyad. 2025 - Present

Welcome to sonyflake
=======================
